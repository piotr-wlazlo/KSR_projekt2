...
public class VariableInitializer {
    public static LinguisticVariable initializeYear() {
        ...
        MembershipFunction funcAbout1983 = new TrapezoidalFunction(
                1981, 1981, 1985, 1987
        );

        MembershipFunction funcAbout1995 = new TrapezoidalFunction(
                1985, 1987, 2000, 2005
        );

        MembershipFunction funcAbout2010 = new TrapezoidalFunction(
                200, 2005, 2017, 2020
        );

        MembershipFunction funcAfter2021 = new TrapezoidalFunction(
                2017, 2020, 2021, 2021
        );
    ...
    public static LinguisticVariable initializePrice() {
        ...
        MembershipFunction funcAbout7500 = new TrapezoidalFunction(
                165, 165, 15000, 20000
        );

        MembershipFunction funcAbout25000 = new TrapezoidalFunction(
                10000, 20000, 30000, 40000
        );

        MembershipFunction funcAbout50000 = new TrapezoidalFunction(
                30000, 40000, 60000, 70000
        );

        MembershipFunction funcMuchOver60000 = new TrapezoidalFunction(
    ...
    public static LinguisticVariable initializeEngineCapacity() {
        ...
        MembershipFunction funcAbout1500 = new TrapezoidalFunction(
                1000, 1000, 1800, 2200
        );

        MembershipFunction funcAbout2500 = new TrapezoidalFunction(
                1800, 2200, 3200, 3800
        );

        MembershipFunction funcAbout4500 = new TrapezoidalFunction(
                3200, 3800, 5200, 6000
        );

        MembershipFunction funcMuchOver5200 = new TrapezoidalFunction(
                5200, 6000, 8400, 8400
        );
    ...
    public static LinguisticVariable initializeHorsepower() {
        ...
        MembershipFunction funcAbout100 = new TrapezoidalFunction(
                55, 55, 120, 170
        );

        MembershipFunction funcAbout200 = new TrapezoidalFunction(
                120, 170, 230, 280
        );

        MembershipFunction funcAbout350 = new TrapezoidalFunction(
                230, 280, 380, 450
        );

        MembershipFunction funcMuchOver380 = new TrapezoidalFunction(
                380, 450, 1001, 1001
        );
    ...
    public static LinguisticVariable initializeTorque() {
        ...
        MembershipFunction funcAbout125 = new TrapezoidalFunction(
                79, 79, 180, 240
        );

        MembershipFunction funcAbout280 = new TrapezoidalFunction(
                180, 240, 320, 380
        );

        MembershipFunction funcAbout450 = new TrapezoidalFunction(
                320, 380, 500, 580
        );

        MembershipFunction funcMuchOver500 = new TrapezoidalFunction(
                500, 580, 1280, 1280
        );
    ...
    public static LinguisticVariable initializeMileage() {
        ...
        MembershipFunction funcAbout25000 = new GaussianFunction(
                0, 25000
        );

        MembershipFunction funcAbout85000 = new GaussianFunction(
                85000, 30000
        );

        MembershipFunction funcAbout180000 = new GaussianFunction(
                180000, 40000
        );

        MembershipFunction funcAbout300000 = new GaussianFunction(
                300000, 50000
        );
    ...
    public static LinguisticVariable initializeFuelTankCapacity() {
        ...
        MembershipFunction funcAbout35 = new TrapezoidalFunction(
                29, 29, 40, 55
        );

        MembershipFunction funcAbout50 = new TrapezoidalFunction(
                40, 55, 65, 75
        );

        MembershipFunction funcAbout85 = new TrapezoidalFunction(
                65, 75, 95, 105
        );

        MembershipFunction funcMuchOver95 = new TrapezoidalFunction(
                95, 105, 242, 242
        );
    ...
    public static LinguisticVariable initializeLength() {
        ...
        MembershipFunction funcMuchUnder430 = new TrapezoidalFunction(
                269, 269, 400, 430
        );

        MembershipFunction funcAbout440 = new TrapezoidalFunction(
                400, 430, 450, 470
        );

        MembershipFunction funcAbout480 = new TrapezoidalFunction(
                450, 470, 490, 510
        );

        MembershipFunction funcMuchOver490 = new TrapezoidalFunction(
                490, 510, 757, 757
        );
    ...
    public static LinguisticVariable initializeWheelbase() {
        ...
        MembershipFunction funcAbout220 = new TrapezoidalFunction(
                187, 187, 245, 260
        );

        MembershipFunction funcAbout265 = new TrapezoidalFunction(
                245, 260, 270, 285
        );

        MembershipFunction funcAbout290 = new TrapezoidalFunction(
                270, 285, 295, 310
        );

        MembershipFunction funcMuchOver295 = new TrapezoidalFunction(
                295, 310, 519, 519
        );
    ...
    public static LinguisticVariable initializeDaysOnMarket() {
        ...
        MembershipFunction funcFresh = new BellFunction(
                10, 2.5, 0
        );

        MembershipFunction funcActive = new BellFunction(
                15, 2.5, 22
        );

        MembershipFunction funcSlowMoving = new BellFunction(
                15, 2.5, 48
        );

        MembershipFunction funcStale = new BellFunction(
                20, 2.5, 80
        );
