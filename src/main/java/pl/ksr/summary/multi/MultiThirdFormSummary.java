...
public class MultiThirdFormSummary implements LinguisticSummary {
    ...
    public MultiThirdFormSummary(Quantifier quantifier,
                                 List<Car> p1,
                                 String p1Name,
    ...
    public String getSummary() {
        ...
        return quantifier.getLabel() + " " + p1Name + " being/having " + qualifiersLabel + " compared to " + p2Name + " are/have " + summarizersLabel;
    }
